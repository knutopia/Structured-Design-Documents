...
Metric M-001 "Metric Name"
  INSTRUMENTED_AT J-001 "a Step"
  INSTRUMENTED_AT P-001 "a Place"
  INSTRUMENTED_AT VS-001 "a ViewState"
  INSTRUMENTED_AT E-001 "an Event"
END
...
Initiative I-001 "Initiative Name"
  ...
  IMPLEMENTED_BY P-001 "a Place"
  IMPLEMENTED_BY VS-001 "a ViewState"
  IMPLEMENTED_BY C-001 "a Component"
  IMPLEMENTED_BY PR-001 "a Process"
  IMPLEMENTED_BY SA-001 "a SystemAction"
END
```
