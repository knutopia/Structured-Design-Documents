...
When linking SDD dontent to an external application makes sense, it is worth asking if a closer integration ("better-than-links"), via API or plug-in makes *more* sense - and if it's worth it. 
