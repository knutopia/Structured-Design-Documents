...
Until there is a graphical editor, SDD files are authored manually, or by using the `sdd add` command line tool, or using an LLM with the SDD Skill: [Using SDD Today](./using_sdd)
