...
SDD files are authored manually, or by using the `sdd add` command line tool, An LLM can also be used, with the SDD Skill. In time, there will be a graphical editor. See [Using SDD Today](./using_sdd)
