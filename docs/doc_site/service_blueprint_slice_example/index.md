...
```bash
pnpm sdd show claim_flow_slice.sdd --view service_blueprint --profile strict --detail detailed --out my_service_blueprint.svg
```
Notes:
...
```bash
pnpm sdd show claim_flow_slice.sdd --view service_blueprint --profile strict --detail detailed --out my_service_blueprint.png --format png
```
