...
## Journey Map
  ...
  Examples: [three_branch_journey_example](../../../examples/rendered/v0.1/journey_map_diagram_type/three_branch_journey_example/), [branching_journey_example](../../../examples/rendered/v0.1/journey_map_diagram_type/branching_journey_example/), [outcome_to_ia_trace_example](../../../examples/rendered/v0.1/journey_map_diagram_type/outcome_to_ia_trace_example/), [service_blueprint_slice_example](../../../examples/rendered/v0.1/journey_map_diagram_type/service_blueprint_slice_example/)
