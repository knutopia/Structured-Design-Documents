...
Status: implementation in progress — Gate 6 long cross-Stage/root accepted, checkpoint pending
...
| 6 — Archetypes and ownership | in progress — long cross-Stage/root accepted, checkpoint pending | user | — | pending | same-Stage skip accepted/checkpointed at `2c2c580`; long cross-Stage/root accepted 2026-07-13; post-acceptance validation pending; later families blocked |
