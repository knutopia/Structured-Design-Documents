...
Status: implementation in progress — Gate 6 same-Stage skip accepted, checkpoint pending
...
| 6 — Archetypes and ownership | in progress — same-Stage skip family accepted, checkpoint pending | user | — | pending | first family accepted 2026-07-13; 2 files/12 tests; 2 files/24 journey regressions; build, deterministic review package, whitespace, and protected baselines clean; later families blocked |
