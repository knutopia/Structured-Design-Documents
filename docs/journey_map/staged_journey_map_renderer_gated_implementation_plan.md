...
Status: implementation in progress — Gate 6 branch family accepted; checkpoint ready
...
| 6 — Archetypes and ownership | in progress — branch accepted, checkpoint ready | user | — | pending | same-Stage skip checkpoint `2c2c580`; long cross-Stage/root checkpoint `3a894be`; branch accepted with human-readability debt assigned to Gates 7–8; post-validation green; join remains blocked until branch checkpoint |
